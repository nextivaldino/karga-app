  ...
  return (
    <div className="root-panel-theme flex min-h-full bg-bg-app text-text-primary">
      <aside className="root-panel-sidebar flex w-[260px] shrink-0 flex-col border-r border-border bg-bg-surface">
        <div className="flex items-center gap-2.5 border-b border-border px-4 py-4"><img src="/karga-logo.svg" alt="" className="h-9 w-9 shrink-0" /><div><p className="text-[15px] font-bold tracking-tight">KARGA <span className="font-normal text-text-tertiary">/ Root</span></p><p className="text-[10px] text-text-tertiary">Centro de controlo global</p></div></div>
        ...
        <div className="border-t border-border p-3"><button type="button" onClick={() => (demo ? avisar('Sessão de teste: sair desativado.') : void logout())} className="flex w-full items-center gap-2 rounded-control px-2 py-2 text-[12px] text-text-secondary hover:bg-bg-app"><SignOut size={18} /> Sair do painel</button></div>
      </aside>
